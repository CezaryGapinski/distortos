/**
 * \file
 * \brief ChipUartDmaV2LowLevel class header for USARTv1 in STM32
 *
...
#ifndef SOURCE_CHIP_STM32_PERIPHERALS_USARTV1_INCLUDE_DISTORTOS_CHIP_CHIPUARTDMAV2TLOWLEVEL_HPP_
#define SOURCE_CHIP_STM32_PERIPHERALS_USARTV1_INCLUDE_DISTORTOS_CHIP_CHIPUARTDMAV2TLOWLEVEL_HPP_
...
/**
 * ChipUartDmaLowLevel class is a low-level UART driver in interrupt mode for USARTv1 in STM32
 *
 * \ingroup devices
 */
...
public:
	...
	constexpr explicit ChipUartDmaLowLevel(const Parameters& parameters,
			ChipUartDmaTransfer& txChipUartDmaTransfer,	ChipUartDmaTransfer& rxChipUartDmaTransfer) :
...
#endif	// SOURCE_CHIP_STM32_PERIPHERALS_USARTV1_INCLUDE_DISTORTOS_CHIP_CHIPUARTDMAV2TLOWLEVEL_HPP_
