/**
 * \file
 * \brief ChipUartInterruptLowLevel class header for USARTv1 in STM32
 *
...
#ifndef SOURCE_CHIP_STM32_PERIPHERALS_USARTV1_INCLUDE_DISTORTOS_CHIP_CHIPUARTINTERRUPTLOWLEVEL_HPP_
#define SOURCE_CHIP_STM32_PERIPHERALS_USARTV1_INCLUDE_DISTORTOS_CHIP_CHIPUARTINTERRUPTLOWLEVEL_HPP_
...
/**
 * ChipUartInterruptLowLevel class is a low-level UART driver for USARTv1 in STM32
 *
 * \ingroup devices
 */
...
public:
	...
	/**
	 * \brief ChipUartInterruptLowLevel's constructor
	 *
	...
	/**
	 * \brief ChipUartInterruptLowLevel's destructor
	 *
...
#endif	// SOURCE_CHIP_STM32_PERIPHERALS_USARTV1_INCLUDE_DISTORTOS_CHIP_CHIPUARTINTERRUPTLOWLEVEL_HPP_
