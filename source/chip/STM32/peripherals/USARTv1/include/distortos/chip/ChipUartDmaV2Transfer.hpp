/**
 * \file
 * \brief ChipUartDmaV2Transfer class header for USARTv1 in STM32
 *
...
#ifndef SOURCE_CHIP_STM32_PERIPHERALS_USARTV1_INCLUDE_DISTORTOS_CHIP_CHIPUARTDMAV2TRANSFER_HPP_
#define SOURCE_CHIP_STM32_PERIPHERALS_USARTV1_INCLUDE_DISTORTOS_CHIP_CHIPUARTDMAV2TRANSFER_HPP_
...
public:
	...
	int start(ChipUartDmaLowLevel& chipUartDmaLowLevel, const uint8_t busWidth, const bool receivingEn);
...
private:
	...
	void transferErrorEvent(ErrorSet errorSet) override;
...
#endif	// SOURCE_CHIP_STM32_PERIPHERALS_USARTV1_INCLUDE_DISTORTOS_CHIP_CHIPUARTDMAV2TRANSFER_HPP_
