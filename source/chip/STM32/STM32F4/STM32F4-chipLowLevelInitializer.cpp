...
#if defined(CONFIG_CHIP_STM32F4_RCC_PLLSAI_ENABLE)

#if defined(CONFIG_CHIP_STM32F4_RCC_LCD_ENABLE)
	configureLcdClockDividers(CONFIG_CHIP_STM32F4_RCC_PLLSAIR, CONFIG_CHIP_STM32F4_RCC_PLLSAIDIVR);
#endif	// defined(CONFIG_CHIP_STM32F4_RCC_LCD_ENABLE)

	enablePllSai(CONFIG_CHIP_STM32F4_RCC_PLLSAIN);

#endif	// defined(CONFIG_CHIP_STM32F4_RCC_PLLSAI_ENABLE)
